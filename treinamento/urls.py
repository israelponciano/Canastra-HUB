...
urlpatterns = [
    ...
    path('<int:treinamento_id>/', views.detalhe_treinamento, name='detalhe_treinamento'),
    ...
    #usuario
    path('<int:treinamento_id>/inscrever/<int:flag>', views.inscrever, name='inscrever'),
    path('<int:treinamento_id>/cancelar/<int:flag>/', views.cancelar_inscricao, name='cancelar'),
]